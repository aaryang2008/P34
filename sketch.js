...
function preload()
{
  bg_img = loadImage('background2.jpeg');
  food = loadImage('rock.jpeg');
  rabbit = loadImage('monkey2.png');
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower = createImg('airblower3.png');
   blower.position(240,30);
   blower.size(120,120);
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  ufo=createSprite(120, height-80,100,100);
  ufo=createImage('ufo.png')
  bunny = createSprite(120,height-80,100,100);
  bunny.scale = 0.2;

  star=createSprite(360,480,20,20)
...
function draw() 
{
  ...
  {
    World.remove(engine.world,bunny);
    fruit = null;
  }
